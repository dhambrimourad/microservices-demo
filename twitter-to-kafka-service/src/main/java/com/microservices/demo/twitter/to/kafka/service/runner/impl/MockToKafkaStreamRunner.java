...
public class MockToKafkaStreamRunner implements StreamRunner {

  private static final Logger LOG = LoggerFactory.getLogger(MockToKafkaStreamRunner.class);
  ...
  public MockToKafkaStreamRunner(
